...
local shenqi_qiling_module = {}

function shenqi_qiling_module:init()
  
	-- _msg_func.bind_player_proto_func(CM.CM_SPIRIT_INHERIT,self.onSpiritInherit,"ProtoInt32Array")
end

function shenqi_qiling_module:initDB(data)
end

--在initDB之后调用的
function shenqi_qiling_module:afterInit()
end

return shenqi_qiling_module