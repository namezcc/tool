...
pbparse:SetProtoPath("../../../../protobuf/")
pbparse:ParseFile("common/Common.proto")
pbparse:ParseFile("client/Client.proto")
-- pbparse:ParseFile("client/ServerMsg.proto")
-- pbparse:ParseFile("client/Task.proto")

CMCODE = pbparse:GetMessage("ClientMsgCodes")
SMCODE = pbparse:GetMessage("ServerMsgCodes")
...
local function CreateGame()
	...
	print("create ply ",cindex,account)
